    ...
    <div id="root">
      ...
      <div className="container mt-4">
        <div>
          ...
          <div className="row">
            {products.map((p, idx) => (
              <div key={p.id} className="custom-card card col-md-4 mb-3">
            ...
            <div key={item.id} className="custom-card card mb-2">
              <div className="card-body text-center">
                ...
                <div className="input-group" style={{ display: "inline-flex", alignItems: "center" }}>
                  <input type="text" className="form-control" readOnly value={item.qty} data-testid={`qty-${item.id}`} style={{ width: 60, textAlign: "center" }} />
                  <div className="input-group-append" style={{ display: "inline-flex", marginLeft: 8 }}>
          ...
          <div className="coupon-wrap mt-3" style={{ maxWidth: 380 }}>
            <div className="input-group">
              ...
              <div className="input-group-append">
                <button className="btn btn-dark" onClick={() => dispatch(applyCoupon(document.getElementById("coupon").value))}>
                  Apply
                </button>
              </div>
            </div>
